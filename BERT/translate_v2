...
def translate_es_to_en(text, _translate_block, max_tokens=1024):
    try:
        """
        ...
        for idx, para in enumerate(paragraphs):
            if para.strip():
                translated = _translate_block(para)
...
class translator():
    ...
    def translate_es_to_en(self, text):
        return translate_es_to_en(text, self._translate_block)
    
    def translate_es_en(self, text):
        return translate_es_en(self, text)
    
    def detect_and_translate(self, text):
        return detect_and_translate(self, text)
